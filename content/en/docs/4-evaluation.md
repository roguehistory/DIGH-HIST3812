...
Proposals will be assessed on collaborative contributions that focus on the process of developing a detailed plan for group execution of your project; with a singular group proposal being submitted in class on November 10th. **Details about submission can be found in the updated guidelines found here: [6.Nov 1st Update – HIST3812a](https://digitalbyzantine.netlify.app/news/nov-1st-update/)** Make sure you read this update. 

Select one individual from your group to submit the document via Brightspace and email me at scottcoleman@cmail.carleton.ca to inform me who will upload the document. The rubric for grading is available via Brightspace under Assignments and Final Project Proposal.
